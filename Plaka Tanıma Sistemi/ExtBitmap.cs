...
namespace WindowsFormsApp1
{
    ...
    {
        #region canvas işlemine çevirme && kopyalama
        ...
        #region Opening/Closing İşlemi

        //Aşındırma ve genişletme işlemlerinin ardından sırasıyla opening ve closing işlemleri yapılır.
